...
WORKBOOK = Path(
    r"C:\Users\tyboy\OneDrive\Documents\Nasa project\outputs\europa_ice_subsurface_simulation\v24_paper_calibrated_dirty_ice_v3_complete_reordered.xlsx"
)
...
def rewrite_xlsx(path: Path) -> None:
    with zipfile.ZipFile(path, "r") as zin:
        ...
        patched_workbook_xml = patch_workbook_xml(workbook_xml)
...
if __name__ == "__main__":
    ...
    print(f"Reordered and hid raw tabs in {WORKBOOK}")
