...
WORKBOOK = Path(
    r"C:\Users\tyboy\OneDrive\Documents\Nasa project\outputs\europa_ice_subsurface_simulation\v25_paper_calibrated_dirty_ice_v3_streamlined.xlsx"
)
...
RENAME = {
    "01_ALL_NUMBERS": "02_ALL_NUMBERS",
    "02_DETAILS_SOURCES": "03_DETAILS_SOURCES",
}
...
def patch_workbook_xml(xml_bytes: bytes) -> bytes:
    ...
    for node in sheet_nodes:
      old_name = node.attrib.get("name")
      if old_name in RENAME:
          node.set("name", RENAME[old_name])
