...
| PRF breakdown stress test | `requiredPrf = 2*maxDoppler*safetyFactor`; `margin = effectivePrf/requiredPrf`. | Flyby speed, wavelength, look angle, slope spread, safety factor, usable PRF. | D5, `computeBreakdownPoint`. | Simplified educational Doppler-Nyquist stress test, not a mission PRF schedule. |
